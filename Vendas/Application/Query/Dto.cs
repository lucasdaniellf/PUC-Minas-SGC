...
{
    public record VendaDto(string id, ClienteDto cliente, DateTime dataVenda, int desconto, Status status, FormaPagamento formaPagamento, IEnumerable<VendaItemDto> itens);
